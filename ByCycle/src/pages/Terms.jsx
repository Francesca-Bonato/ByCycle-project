export function Terms() {
  return (
    <div className="container-fluid flex-row tracking-widest p-10">
      ...
      <p>
        The ByCycle website located at https://www.bycycle.it is a copyrighted
        work belonging to ByCycle. Certain features of the Site may be subject
      ...
      <p>
        ...
        ByCycle uses 'cookies'. These cookies are used to store information
      ...
      <p>
        ...
        the Company should be sent to: Via Thailandia 6, Milano 20121 MI. After
      ...
      <p>
        ...
        the personal jurisdiction of the courts located within it County,
      ...
      <p>Address: Via Thailandia 6, Milano 20121 MI</p>
      <p>Email: bycyclewebapp@email.it</p>
    </div>
  );
}
