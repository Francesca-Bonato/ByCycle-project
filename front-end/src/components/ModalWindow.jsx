            ...
            >
              <DialogPanel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                ...
                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  <Button innerText={"Deactivate"} onClick={handleDelete} />
                  {/* <button
                    type="button"
                    className="inline-flex w-full justify-center rounded-md bg-[#232323] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[black] sm:ml-3 sm:w-auto"
                  ...
                  <Button
                    innerText={"Cancel"}
                    className={"bg-[#999898ce] text-black mr-2"}
                    onClick={onCancel}
                  />
                  {/* <button
                    type="button"
